...
# Output dir overridable via env so the GH Action can write into the
# trending-data branch checkout (different working dir from where the script lives).
OUT_DIR = Path(__import__("os").environ.get("TRENDING_OUT_DIR", str(ROOT / "data" / "trending")))
